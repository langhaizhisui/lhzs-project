...
//	 * @throws Exception
//	 */
//	public static String genMd5ConSec(Object obj,String md5key) throws Exception {
//		if(null == obj) {
//			return null;
//		}
//
...
//			}
//		}
//		String forEncodeStr = sb.toString() + md5key;
//		System.out.println("待MD5加密的字符串" + forEncodeStr);
//		String result = SecureUtil.md5X16Str(forEncodeStr, Constants.ENCODE_GBK);
//
//		return result;
//	}
...
//	 * 支付密码加盐
//	 * @param uid
//	 * @param password md5后的密码（也就是前台传到服务端，base64解码之后的密码）
//	 * @return
//	 */
//    public static String pwdSaltMD5(Integer uid, String password) {
//    	String salt = "ibaboss20170301";
//		StringBuilder psw = new StringBuilder();
//		psw.append(uid);
//		psw.append(salt);
//		psw.append(password.toUpperCase()); // app过来 base64解后是大写的，h5过来是小写。统一大写处理，再加盐处理
//		return md5X16Str(psw.toString(),Constants.ENCODE_UTF8);
//    }
}
