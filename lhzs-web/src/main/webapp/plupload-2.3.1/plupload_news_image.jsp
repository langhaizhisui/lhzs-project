...
function pldeleteFile1(fileId){
	$.messager.confirm('确认', '是否确认删除此文件?', function(r){
		if(r){
			...
			$.ajax({
				type : 'post',
				url : ctx+"/newsImageUpload/deleteFile",
				data : 'id='+resourceid,
				dataType: "json",
...
$(function(){
	var uploader1 = new plupload.Uploader({
        ...
        url : ctx+"/newsImageUpload/fileUpload?userId=${userBean.id}",
...
&nbsp;&nbsp;<span id="uploader1" style="cursor:pointer;" class="uploader-btn">上传图片</span>
</div>
